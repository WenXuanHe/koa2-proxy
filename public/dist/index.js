...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _addOne = __webpack_require__(8);
	
	var _thrities = __webpack_require__(39);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addOne = exports.addOne = function addOne(proxy_url) {
	    if (typeof _axios2.default.post === 'undefined') {
	    ...
	    return function (id) {
	        param.data.id = id;
	        return _axios2.default.post(proxy_url, param).then(function (res) {
	            res = res.data;
	            if (!res.code) {
	                alert(res.message);
	                return;
